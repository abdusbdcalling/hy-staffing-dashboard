      ...
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white ">
        <ul className="space-y-3 font-medium">
          <li>
            <Link
              to="/"
              className="flex items-center p-2 text-[#505961]  rounded-lg  hover:bg-gray-100  group"
              onClick={handleOnClick}
            >
              <MdOutlineDashboard />
              <span className="ms-3 font-semibold uppercase">Dashboard</span>
            </Link>
          </li>
          ...
          <li>
            <Link
              ...
              className="flex items-center p-2 text-[#6B7986]  rounded-lg  hover:bg-gray-100  group"
              onClick={handleOnClick}
            >
              <FaRegUser />
          ...
          <li>
            <button
              ...
              className="flex items-center w-full p-2 text-[#6B7986]  rounded-lg  hover:bg-gray-100  group"
            >
              <IoSettingsOutline />
